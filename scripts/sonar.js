// Sonar
// Ouvre un panneau flottant qui charge sonar.html (servi sur toolkit.vesperlab.dev) dans une iframe.
...
(function () {
  ...
  // URL fixe de la page publiée. Le sous-domaine est l'adresse canonique ; l'ancienne
  // URL GitHub Pages (vesperlab-a11y.github.io/Vesper-Toolkit/) répond encore en parallèle.
  var URL_SONAR = 'https://toolkit.vesperlab.dev/sonar.html';
