  ...
  try {
    ...
    function vlScan() {
      ...
      Array.prototype.forEach.call(links, function (link) {
        ...
        var target = vlBuildSelector(link);
        ...
        data.push({ ref: ref, sev: sev, _name: name, _resolved: resolved, _notes: notes, _tags: tags, target: target, hrefRaw: hrefRaw, blank: blank, isWarned: isWarned, snippet: wrap.innerHTML });
      });
      ...
      var rows = data.map(function (d) {
        ...
        return {
          ref: d.ref, sev: d.sev, snippet: d.snippet, tags: d._tags, target: d.target,
          cells: [
